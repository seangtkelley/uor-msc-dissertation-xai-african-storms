...
\begin{longtable}{>{\raggedright\arraybackslash}p{0.25\linewidth} p{0.50\linewidth} >{\raggedright\arraybackslash}p{0.15\linewidth}}
    ...
    \texttt{domain\_mean\_tcwv} & Mean TCWV over the entire domain of \acrshort{era5} data & \unit{\kilogram\per\meter\squared} \\
    ...
    \texttt{domain\_mean\_cape} & Mean CAPE over the entire domain of \acrshort{era5} data & \unit{\joule\per\kilogram} \\
...
\begin{longtable}{>{\raggedright\arraybackslash}p{0.27\linewidth} p{0.43\linewidth} >{\raggedright\arraybackslash}p{0.20\linewidth}}
    ...
    \texttt{storm\_max\_intensity\_era5 \_first\_points} & Predict storm minimum BT using \acrshort{era5} features and first observation only & \texttt{storm\_min\_bt} \\
    ...
    \texttt{storm\_direction\_era5 \_first\_points} & Predict storm bearing using \acrshort{era5} features and first observation only & \texttt{storm\_bearing} \\
    \midrule
