...
\begin{longtable}{>{\raggedright\arraybackslash}p{0.33\linewidth} p{0.42\linewidth} >{\raggedright\arraybackslash}p{0.15\linewidth}}
    ...
    \texttt{mean\_q\_850} & 850 hPa specific humidity & \unit{\kilogram\per\kilogram} \\
    \texttt{mean\_q\_500} & 500 hPa specific humidity & \unit{\kilogram\per\kilogram} \\
    \texttt{mean\_q\_200} & 200 hPa specific humidity & \unit{\kilogram\per\kilogram} \\
