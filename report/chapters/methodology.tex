...
The hyperparameters tuned are included in Table \ref{tab:wandb-sweep-config}.

\begin{figure}[ht]
    \centering
    \missingfigure{Table of hyperparameter tuning configuration.}
    \caption{\acrshort{wandb} Sweep Configuration for \acrshort{xgb} Hyperparameter Tuning.}
