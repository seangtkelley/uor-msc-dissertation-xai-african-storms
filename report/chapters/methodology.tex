...
\begin{table}[ht]
    \centering
    \caption{\acrshort{era5} Data File Patterns, Descriptions, and Units. "PRESSURE" and "YEAR" in the file patterns are placeholders for the respective pressure levels and year (2014-2019). The specific pressure levels available for each variable are detailed in the description.}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.95\textwidth]{../figures/generated/exploration/feature_correlation_heatmap.png}
...
\begin{longtable}{>{\raggedright\arraybackslash}p{0.4\linewidth} >{\raggedright\arraybackslash}p{0.6\linewidth}}
    \caption{All features excluded in this thesis, including those removed for data leakage, high correlations, and future information.}
...
\begin{longtable}{>{\raggedright\arraybackslash}p{0.27\linewidth} p{0.43\linewidth} >{\raggedright\arraybackslash}p{0.20\linewidth}}
    \caption{Summary of all experiments conducted in this thesis.}
