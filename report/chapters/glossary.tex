...
{
    name=Deep Learning,
    description={Subset of machine learning that leverages \acrfullpl{ann} with many layers to learn complex, non-linear patterns from large amounts of data}
}
...
\newglossaryentry{explai}
{
    ...
    description={Subfield of \acrlong{ai} that aims to produce human-understandable explanations for the results and workings of complex \acrlong{ml} models}
}
...
\newglossaryentry{ensemblelearning}
{
    ...
    description={A \acrlong{ml} technique where multiple models are trained on the same task or subdivisions of the same task and their outputs aggregated to improve overall performance}
}
...
\newacronym{eat}{EAT}{\href{https://www.timeanddate.com/time/zones/eat}{Eastern Africa Time} (UTC+3)}
\newacronym{bt}{BT}{Cloud-top Brightness Temperature}
