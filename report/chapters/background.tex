...
hard-to-model subgrid processes, which have long been a source of instability in numerical models \insertref{parameterization being hard}.


Modern nowcasting methods, such as physics-conditional deep generative models (e.g., NowcastNet), unify physical evolution with statistical learning to achieve short-term, high-resolution forecasts of extreme precipitation by leveraging radar data and ensemble neural networks[]. 
...
\subsection{Inherently Interpretable Model Frameworks}
